...
func setup(p_stage_mngr: EMC_StageMngr) -> void:
	...
	doorbell_agathe.setup("Agathe", EMC_Action.IDs.SC_MARKET) #TODO update stage name
	...
	doorbell_mert.setup("Mert", EMC_Action.IDs.SC_MARKET)  #TODO, connect a stage to doorbellBtn
	...
	doorbell_veronika.setup("Veronika & Kris", EMC_Action.IDs.SC_MARKET)  #TODO, connect a stage to doorbellBtn
